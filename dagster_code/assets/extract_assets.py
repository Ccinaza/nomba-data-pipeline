...
def raw_plans(context: AssetExecutionContext) -> Output:
    ...
    context.log.info(
        "Loader Initialized. Starting PostgreSQL savings_plan extraction (incremental mode)..."
    )
...
def raw_savings_transactions(context: AssetExecutionContext) -> Output:
    ...
    context.log.info(
        "Loader initialized. Starting PostgreSQL savingsTransaction extraction (incremental mode)..."
    )
